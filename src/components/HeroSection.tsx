          ...
          <div className="text-white space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <div className="space-y-2 sm:space-y-3 lg:space-y-4">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                Get Free <span className="block text-accent">Landscaping Quotes</span>
                in Minutes
              </h1>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-6 shadow-strong border border-white/20">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                >
                  Click to Get 3 Free Landscaping Quotes in Minutes
                </Button>
              </div>
            ...
            <div className="grid gap-3 sm:gap-4">
              <div className="card-gradient rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 shadow-soft border border-white/20">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-muted-foreground text-xs sm:text-sm">Homeowners across Australia count on us for their landscaping solutions at competitive and affordable prices, without compromising on quality.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-gradient rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 shadow-soft border border-white/20">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="font-semibold text-foreground mb-1 sm:mb-2 text-sm sm:text-base">Australia's Most Reliable Landscaping Professionals</h3>
                    <p className="text-muted-foreground text-xs sm:text-sm">Quotes are sourced only from screened, reviewed, and highly-rated landscaping contractors in your suburb.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-gradient rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 shadow-soft border border-white/20">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-muted-foreground text-xs sm:text-sm">Get landscaping quotes from local contractors in minutes — no matter where you are in Australia.</p>
                  </div>
                </div>
              </div>
            </div>
