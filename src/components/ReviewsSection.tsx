...
const ReviewsSection = () => {
  const reviews = [{
    ...
    location: "Sydney, NSW",
    rating: 5,
    text: "Such a smooth and easy process! Three quotes arrived almost instantly, and the landscaper I picked did a flawless job. My new garden looks stunning — I'm absolutely thrilled!",
    project: "Garden Landscaping – Full Backyard"
  }, {
    name: "Mark",
    location: "Melbourne, VIC",
    rating: 5,
    text: "Super impressed! The quotes were spot-on, and the landscaper I chose was fantastic from day one. They finished earlier than promised, and the turf looks perfect. Highly recommended!",
    project: "Turf Installation – 120sqm"
  }, {
    name: "James",
    ...
    project: "Outdoor Renovation – Patio & Decking"
  }, {
    name: "Jessica",
    location: "Sydney, NSW",
    rating: 5,
    ...
    project: "Garden Design & Planting"
  }];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-base sm:text-xl text-muted-foreground max-w-3xl mx-auto px-4">
            Read what our customers say about their landscaping experience with our platform
          </p>
        </div>
        ...
        <div className="card-gradient rounded-2xl p-8 shadow-soft text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8 mb-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-muted-foreground">Licensed & Insured Landscapers</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center">
                <span className="text-white text-xs">✓</span>
