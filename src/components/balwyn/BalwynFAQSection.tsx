...
const BalwynFAQSection = () => {
  const faqs = [
    { question: "How much does landscaping cost in Balwyn?", answer: "Colorbond typically costs $75-$120/m, timber $65-$140/m, aluminium garden design $150-$300/m." },
    { question: "Do I need a permit for landscaping in Balwyn?", answer: "In Balwyn (Boroondara Council), landscaping under 2m generally don't require a permit. Heritage overlays may apply." },
    { question: "What's the best landscaping for Balwyn?", answer: "Timber and heritage-style landscaping suit Balwyn's character homes. Colorbond is popular for modern builds." },
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Balwyn Landscaping FAQs</h2>
