...
const BlackburnFAQSection = () => {
  const faqs = [
    { question: "How much does landscaping cost in Blackburn?", answer: "Colorbond typically costs $75-$120/m, timber $65-$140/m, aluminium garden design $150-$300/m." },
    { question: "Do I need a permit for landscaping in Blackburn?", answer: "In Blackburn (Whitehorse Council), landscaping under 2m generally don't require a permit." },
    { question: "What's the best landscaping for Blackburn?", answer: "Timber is popular in Blackburn's leafy, established streets. Colorbond offers low maintenance." },
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Blackburn Landscaping FAQs</h2>
