...
const CroydonFAQSection = ({
  ...
  const faqs = [{
    ...
    question: "How long will my landscaping last in Croydon?",
    answer: "Landscaping lifespan depends on the material and Croydon area climate. A well-installed Colorbond landscaping or aluminium landscaping can last 20–30 years, while turf installation generally lasts 10–20 years with proper care. Regular maintenance, high-quality installation, and choosing the right landscaping material for the Croydon area all play a major role in how long your landscape will last."
  }, {
    ...
    question: "Do I need my neighbour's approval for a new boundary landscaping in Croydon?",
    ...
    question: "How close to the boundary can I build my landscaping in Croydon?",
    ...
    question: "How do I choose the right landscaping for my home in Croydon?",
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Got questions about landscaping in Croydon? We've got answers. Here's everything you need to know about
            getting your perfect landscape installed in Croydon.
          </p>
        </div>
        ...
        <div className="text-center mt-12 p-8 rounded-2xl bg-gradient-to-r from-primary/5 via-accent/5 to-primary/5 border border-accent/20">
          ...
          <p className="text-muted-foreground mb-6">
            Our local landscaping experts in Croydon are here to help. Get your free quotes and ask them anything!
          </p>
