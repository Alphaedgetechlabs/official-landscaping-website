...
const KeysboroughHowItWorks = () => {
  const steps = [
    { icon: FileText, title: "Describe Your Project", description: "Tell us about your landscaping needs in Keysborough.", step: "01" },
    { icon: Users, title: "Get Matched", description: "We connect you with up to 3 verified Keysborough landscaping contractors.", step: "02" },
    { icon: ThumbsUp, title: "Compare & Choose", description: "Review quotes and choose the best Keysborough landscaper.", step: "03" },
  ];
  return (
    <section className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">Getting quotes for your Keysborough landscaping project is easy.</p>
        </div>
