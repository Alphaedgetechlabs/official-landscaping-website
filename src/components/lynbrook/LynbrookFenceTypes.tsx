...
interface LynbrookFenceTypesProps {
  onQuoteClick?: () => void;
}
const LynbrookFenceTypes = ({
  onQuoteClick
}: LynbrookFenceTypesProps) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
            Choose Your Perfect Landscaping in Lynbrook
          </h2>
          <p className="text-base sm:text-xl text-white/70 max-w-3xl mx-auto px-4">
            Discover Lynbrook landscaping options tailored to your needs, budget, and style.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {fenceTypes.map(fence => <Card key={fence.id} className={`relative shadow-strong hover:shadow-accent transition-smooth group cursor-pointer ${fence.popular ? "border-accent ring-2 ring-accent/20" : ""}`}>
              ...
              <CardHeader className="text-center">
                ...
                <div className="text-muted-foreground text-sm font-normal text-center">Lynbrook</div>
        ...
        <div className="mt-16 text-center">
          <div className="card-gradient rounded-2xl p-8 shadow-soft border border-border">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Our expert Lynbrook team can help you select the perfect landscaping solution based on your specific needs, budget, and property requirements.
            </p>
...
export default LynbrookFenceTypes;