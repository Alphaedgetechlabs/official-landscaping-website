...
const NobleParkFAQSection = () => {
  const faqs = [
    { question: "How much does landscaping cost in Noble Park?", answer: "Colorbond typically costs $75-$120/m, timber $65-$140/m, aluminium garden design $150-$300/m." },
    { question: "Do I need a permit for landscaping in Noble Park?", answer: "In Noble Park (Greater Dandenong Council), landscaping under 2m generally don't require a permit." },
    { question: "What's the best landscaping for Noble Park?", answer: "Colorbond is popular in Noble Park for its durability and modern appearance." },
    ...
    { question: "What areas do you service?", answer: "Noble Park and surrounds including Dandenong, Springvale, Keysborough, Clayton." },
    ...
    { question: "Do you offer commercial landscaping?", answer: "Yes! We handle both residential and commercial landscaping projects in Noble Park." },
  ];
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Noble Park Landscaping FAQs</h2>
...
export default NobleParkFAQSection;
