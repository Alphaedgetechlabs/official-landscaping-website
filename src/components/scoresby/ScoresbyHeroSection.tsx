      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
            Professional Landscaping in <span className="text-primary">Scoresby</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Get 3 free quotes from verified local landscaping contractors in Scoresby. Compare prices, read reviews, and choose the best landscaper for your property.
          </p>
