...
const SomervilleFAQSection = () => {
  const faqs = [
    { question: "How much does landscaping cost in Somerville?", answer: "Colorbond typically costs $75-$120/m, timber $65-$140/m, aluminium garden design $150-$300/m." },
    { question: "Do I need a permit for landscaping in Somerville?", answer: "In Somerville (Mornington Peninsula Shire), landscaping under 2m generally don't require a permit." },
    { question: "What's the best landscaping for Somerville?", answer: "Timber is popular in Somerville's semi-rural setting. Colorbond is also excellent for low maintenance." },
    ...
    { question: "Do you service rural properties?", answer: "Yes! We handle rural landscaping including larger acreage properties in Somerville." },
  ];
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Somerville Landscaping FAQs</h2>
