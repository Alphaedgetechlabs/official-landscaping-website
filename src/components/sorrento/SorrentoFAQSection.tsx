...
const SorrentoFAQSection = ({
  ...
  const faqs = [{
    ...
    question: "Do I need my neighbour's approval for a new boundary landscaping in Sorrento?",
    ...
    question: "How close to the boundary can I build my landscaping in Sorrento?",
    ...
    question: "How do I choose the right landscaping for my home in Sorrento?",
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Got questions about landscaping in Sorrento? We've got answers. Here's everything you need to know about
            getting your perfect landscape installed in Sorrento.
          </p>
        </div>
        ...
        <div className="text-center mt-12 p-8 rounded-2xl bg-gradient-to-r from-primary/5 via-accent/5 to-primary/5 border border-accent/20">
          ...
          <p className="text-muted-foreground mb-6">
            Our local landscaping experts in Sorrento are here to help. Get your free quotes and ask them anything!
          </p>
...
export default SorrentoFAQSection;