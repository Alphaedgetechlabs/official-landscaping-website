...
interface SouthYarraHowItWorksProps {
  onQuoteClick: () => void;
}

const SouthYarraHowItWorks = ({ onQuoteClick }: SouthYarraHowItWorksProps) => {
  const steps = [
    {
      icon: Send,
      title: "Click Quotes",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-muted-foreground">
            Get your South Yarra landscape project started in 3 easy steps
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <Button variant="hero" size="lg" onClick={onQuoteClick}>
            Get Your 3 Free South Yarra Landscaping Quotes Now
          </Button>
        </div>
      </div>
    </section>
...
export default SouthYarraHowItWorks;
