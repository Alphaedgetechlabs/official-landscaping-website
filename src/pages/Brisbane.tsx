...
const Brisbane = () => {
  useDocumentTitle("Brisbane Landscaping Quotes — Get 3 Free Quotes in Minutes");
  ...
  const recentProjects = [{
    ...
    rating: 5,
    review: "The whole process was easy and well managed. The team arrived on schedule and the garden turned out great."
  }, {
    suburb: "New Farm",
    type: "Turf Installation",
    rating: 5,
    review: "Quality work backed by reasonable pricing. A solid choice for anyone needing landscaping."
  }, {
    suburb: "West End",
    type: "Outdoor Renovation",
    rating: 5,
    review: "The final result went beyond what we expected. The garden looks great and the customer service was outstanding."
  }];
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">Professional landscaping services across Greater Brisbane. Local landscapers, trusted by 1,500+ Brisbane homeowners.</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Local landscapers understand Brisbane's unique climate, soil conditions, and outdoor living styles</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 accent-gradient rounded-full flex items-center justify-center flex-shrink-0 mt-1">
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img alt="Brisbane Landscaping Projects" className="w-full h-full object-cover" src="/lovable-uploads/b398ce61-451a-430e-8e0c-bd29476ef2c4.webp" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Transform Your Brisbane Garden?
            </h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">Join 1,000's of happy Brisbane homeowners. Get your free landscaping quotes in 60 seconds.</p>
