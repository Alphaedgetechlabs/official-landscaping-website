...
const Canberra = () => {
  useDocumentTitle("Canberra Landscaping Quotes — Get 3 Free Quotes in Minutes");
  ...
  const recentProjects = [{
    ...
    rating: 5,
    review: "Impressed with both the service and the outcome. The team was dependable and the garden came out beautifully."
  }, {
    suburb: "Woden",
    ...
    rating: 5,
    review: "The end result exceeded what we had in mind. Great-looking outdoor area backed by excellent service."
  }];
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">Professional landscaping services across Greater Canberra. Local landscapers, trusted by 1,100+ Canberra homeowners.</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Local landscapers understand Canberra's unique climate, soil conditions, and outdoor living styles</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 accent-gradient rounded-full flex items-center justify-center flex-shrink-0 mt-1">
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img alt="Canberra Landscaping Projects" className="w-full h-full object-cover" src="/lovable-uploads/955ee7f3-f949-41dd-bf06-5a1418ae50b3.webp" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            ...
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">Join 1,000's of happy Canberra homeowners. Get your free landscaping quotes in 60 seconds.</p>
