...
const ChainLinkLandscaping = () => {
  ...
  const benefits = [{
    ...
    description: "Most economical landscaping option without compromising on security"
  }, {
    icon: Clock,
  ...
  const applications = [{
    ...
    name: "Rural",
    description: "Large acreage & farm landscaping",
    icon: ruralIcon
  }];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                ...
                Durable, affordable, and quick to install retaining walls.
              </p>
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img src="/lovable-uploads/chain-link-landscaping-hero.webp" alt="Chain Link Landscaping Installation" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Chain link landscaping is manufactured to Australian standards, 
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl overflow-hidden shadow-elegant">
                <img src="/lovable-uploads/chain-link-landscaping-features.webp" alt="Retaining Walls Features" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="applications" className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Chain link landscaping suits a wide range of residential and commercial needs
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Install Retaining Walls?
            </h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              Get free quotes today for affordable, durable retaining walls
            </p>
...
export default ChainLinkLandscaping;