...
const Darwin = () => {
  useDocumentTitle("Darwin Landscaping Quotes — Get 3 Free Quotes in Minutes");
  ...
  const recentProjects = [{
    ...
    rating: 5,
    review: "Everything was handled efficiently and with care. The crew arrived as promised and delivered a garden that looks outstanding."
  }, {
    suburb: "Parap",
    ...
    type: "Garden Design",
    rating: 5,
    review: "The outcome went well beyond what we anticipated. The garden is beautifully finished and the service was exceptional throughout."
  }];
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">Professional landscaping services across Greater Darwin. Local landscapers, trusted by 600+ Darwin homeowners.</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Local landscapers understand Darwin's unique climate, soil conditions, and outdoor living styles</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 accent-gradient rounded-full flex items-center justify-center flex-shrink-0 mt-1">
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img alt="Darwin Landscaping Projects" className="w-full h-full object-cover" src="/lovable-uploads/6d573bf3-2ef8-45eb-b8e9-df0db865b8d5.webp" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Transform Your Darwin Garden?
            </h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">Join happy Darwin homeowners. Get your free landscaping quotes in 60 seconds.</p>
