...
const FAQ = () => {
  useDocumentTitle("Frequently Asked Questions — QuoteMyLandscaping");
  ...
  const faqCategories = [{
    ...
    faqs: [{
      question: "How do I get a landscaping quote?",
      answer: "Simply click 'Get Free Quotes' on our website, fill out the quick form with your landscaping requirements, and we'll connect you with up to 3 verified local landscapers who will provide competitive quotes within 1-48 hours."
    }, {
    ...
    title: "About Our Landscapers",
    faqs: [{
      question: "How are landscapers verified?",
      answer: "All landscapers in our network undergo a thorough verification process including license verification, insurance checks, and reference verification."
    }, {
      question: "Are the landscapers licensed and insured?",
      answer: "Yes, we only work with landscapers who hold valid licenses and comprehensive insurance coverage."
    }]
  }, {
    title: "Costs & Payment",
    faqs: [{
      question: "How much does landscaping cost?",
      answer: "Costs vary by service: Garden Landscaping from $3,000, Turf Installation from $1,800, Garden Design from $2,500, Outdoor Renovations from $4,000."
    }]
  }];
  return <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-primary/5 via-background to-accent/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Find answers to common questions about our landscaping quote platform.</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-foreground/80 mb-8">Our team is here to help with any landscaping questions.</p>
