...
const FeatureLandscaping = () => {
  const handleQuoteClick = () => {
    window.location.href = QUOTE_URL;
  };
  const handleViewDesigns = () => {
    scrollToSection("landscaping-styles");
  };
  const benefits = [{
    icon: Sparkles,
    title: "Unique Designs",
    description: "Stand out with custom decorative patterns and artistic landscaping designs"
  }, {
    icon: Paintbrush,
  ...
  return <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Feature<br />
                <span className="text-gradient">Landscaping Solutions</span>
              </h1>
              <p className="text-lg text-muted-foreground mb-8">
                Make a statement with custom garden maintenance. 
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img src="/lovable-uploads/feature-landscaping-hero-2.webp" alt="Feature Landscaping Installation" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                The feature landscaping options are limited only by your imagination. 
                Work with our landscaping contractors to create something truly extraordinary.
              </p>
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl overflow-hidden shadow-elegant">
                <img src="/lovable-uploads/feature-landscaping-designs.webp" alt="Garden Maintenance Designs" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Styles Section */}
      <section id="landscaping-styles" className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Garden Maintenance Styles
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Create Your Feature Landscaping?
            </h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              Get a free consultation and quotes for your custom garden maintenance project
            </p>
...
export default FeatureLandscaping;