...
const Melbourne = () => {
  useDocumentTitle("Melbourne Landscaping Quotes — Get 3 Free Quotes in Minutes");
  ...
  const getSuburbPath = (suburb: string) => {
    ...
    const suburbRoutes: Record<string, string> = {
      "pakenham": "/vic/pakenham-landscaping",
      "portsea": "/vic/portsea-landscaping",
      "sorrento": "/vic/sorrento-landscaping",
      "mount martha": "/vic/mount-martha-landscaping",
      "langwarrin": "/vic/langwarrin-landscaping",
      "frankston": "/vic/frankston-landscaping",
      "carrum downs": "/vic/carrum-downs-landscaping",
      "mornington": "/vic/mornington-landscaping",
      "rosebud": "/vic/rosebud-landscaping",
      "mount eliza": "/vic/mount-eliza-landscaping",
      "cranbourne": "/vic/cranbourne-landscaping",
      "berwick": "/vic/berwick-landscaping",
      "narre warren": "/vic/narre-warren-landscaping",
      "officer": "/vic/officer-landscaping",
      "botanic ridge": "/vic/botanic-ridge-landscaping",
      "lynbrook": "/vic/lynbrook-landscaping",
      "ringwood": "/vic/ringwood-landscaping",
      "lilydale": "/vic/lilydale-landscaping",
      "rowville": "/vic/rowville-landscaping",
      "croydon": "/vic/croydon-landscaping",
      "box hill": "/vic/box-hill-landscaping",
      "toorak": "/vic/toorak-landscaping",
      "glen waverley": "/vic/glen-waverley-landscaping",
      "richmond": "/vic/richmond-landscaping",
      "south yarra": "/vic/south-yarra-landscaping",
      "doncaster": "/vic/doncaster-landscaping",
      "st kilda": "/vic/st-kilda-landscaping",
      "mount waverley": "/vic/mount-waverley-landscaping",
      "carlton": "/vic/carlton-landscaping",
      "dandenong": "/vic/dandenong-landscaping",
      "bayswater": "/vic/bayswater-landscaping",
      "clayton": "/vic/clayton-landscaping",
      "wantirna": "/vic/wantirna-landscaping",
      "ferntree gully": "/vic/ferntree-gully-landscaping",
      "seaford": "/vic/seaford-landscaping",
      "clyde": "/vic/clyde-landscaping",
      "boronia": "/vic/boronia-landscaping",
      "wheelers hill": "/vic/wheelers-hill-landscaping",
      "springvale": "/vic/springvale-landscaping",
      "templestowe": "/vic/templestowe-landscaping",
      "ashwood": "/vic/ashwood-landscaping",
      "hampton park": "/vic/hampton-park-landscaping",
      "mooroolbark": "/vic/mooroolbark-landscaping",
      "kilsyth": "/vic/kilsyth-landscaping",
      "burwood": "/vic/burwood-landscaping",
      "endeavour hills": "/vic/endeavour-hills-landscaping",
      "keysborough": "/vic/keysborough-landscaping",
      "somerville": "/vic/somerville-landscaping",
      "blackburn": "/vic/blackburn-landscaping",
      "noble park": "/vic/noble-park-landscaping",
      "balwyn": "/vic/balwyn-landscaping",
      "chirnside park": "/vic/chirnside-park-landscaping",
      "scoresby": "/vic/scoresby-landscaping",
      "hallam": "/vic/hallam-landscaping",
      "mulgrave": "/vic/mulgrave-landscaping",
      "beaconsfield": "/vic/beaconsfield-landscaping",
      "chelsea": "/vic/chelsea-landscaping",
      "nunawading": "/vic/nunawading-landscaping",
      "rye": "/vic/rye-landscaping",
      "mitcham": "/vic/mitcham-landscaping",
      "dromana": "/vic/dromana-landscaping",
      "hastings": "/vic/hastings-landscaping",
      "heathmont": "/vic/heathmont-landscaping",
      "knoxfield": "/vic/knoxfield-landscaping",
      "skye": "/vic/skye-landscaping",
      "montrose": "/vic/montrose-landscaping",
      "warranwood": "/vic/warranwood-landscaping",
      "the basin": "/vic/the-basin-landscaping",
      "safety beach": "/vic/safety-beach-landscaping",
      "wonga park": "/vic/wonga-park-landscaping",
      "lyndhurst": "/vic/lyndhurst-landscaping",
      "mentone": "/vic/mentone-landscaping",
    };
  ...
  const recentProjects = [{
    suburb: "Richmond",
    type: "Timber Landscaping",
    rating: 5,
    review: "Very happy with the service provided. The landscapers were on time and the quality of work is excellent."
  }, {
    suburb: "St Kilda",
    type: "Garden Design",
    rating: 5,
    ...
    suburb: "Brunswick",
    type: "Turf Installation",
    rating: 5,
    review: "Couldn't be happier with the outcome. The garden is beautiful and the support throughout was excellent."
  }];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
              ...
              <br />
              <span className="text-gradient">Landscaping Specialists</span>
            </h1>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">Professional landscaping services across Greater Melbourne. Local landscapers, trusted by 2,800+ Melbourne homeowners.</p>
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">See what your neighbours are saying about their landscaping projects</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Local landscapers understand Melbourne's unique climate, soil conditions, and outdoor living styles</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 accent-gradient rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Local expert landscaping contractors on all projects.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img alt="Melbourne Landscaping Projects" className="w-full h-full object-cover" src="/lovable-uploads/44029f16-3161-4138-a651-53190199f13e.webp" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Transform Your Melbourne Garden?
            </h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">Join 1,000's of happy Melbourne homeowners. Get your free landscaping quotes in 60 seconds.</p>
