...
const PrivacyPolicy = () => {
  useDocumentTitle("Privacy Policy — QuoteMyLandscaping");
          ...
          <div className="space-y-8">
            <div className="bg-card border border-border rounded-xl p-8">
              ...
              <p className="text-muted-foreground mb-4">
                QuoteMyLandscaping ("we", "our", "us") is committed to protecting your privacy and handling your personal information in accordance with the Privacy Act 1988 (Cth) and the Australian Privacy Principles (APPs).
              </p>
              <p className="text-muted-foreground mb-4">
            ...
            <div className="bg-card border border-border rounded-xl p-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                ...
                <li>Details about your landscaping project</li>
            ...
            <div className="bg-card border border-border rounded-xl p-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                ...
                <li>share your details with up to three landscaping contractors;</li>
            ...
            <div className="bg-card border border-border rounded-xl p-8">
              ...
              <p className="text-muted-foreground mb-4">
                We provide your contact details and job information to selected landscaping contractors so they can contact you directly.
              </p>
              <p className="text-muted-foreground mb-4">
                Once provided, QuoteMyLandscaping has no control over:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
            ...
            <div className="bg-card border border-border rounded-xl p-8">
              ...
              <div className="text-muted-foreground">
                <p className="font-semibold">QuoteMyLandscaping – Privacy Officer</p>
