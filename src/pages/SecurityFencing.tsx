          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Security<br />
                <span className="text-gradient">Landscaping Systems</span>
              </h1>
              <p className="text-lg text-muted-foreground mb-8">
                Protect your assets with professional-grade hard landscaping. 
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img src="/lovable-uploads/security-landscaping-hero.webp" alt="Security Landscaping Installation" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Security landscaping solutions meet the highest standards for 
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl overflow-hidden shadow-elegant">
                <img src="/lovable-uploads/security-landscaping-features.webp" alt="Hard Landscaping Features" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
...
export default SecurityLandscaping;