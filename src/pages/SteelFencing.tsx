...
const SteelLandscaping = () => {
  ...
  const benefits = [{
    ...
    icon: Hammer,
    title: "Built to Last",
    description: "Properly treated decking & pergolas can last 50+ years with minimal maintenance"
  }, {
    icon: Cog,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Discover the ultimate in landscaping strength and longevity. 
                Steel landscaping combines industrial durability with elegant design.
              </p>
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img src="/lovable-uploads/steel-landscaping-hero.webp" alt="Steel Landscaping Installation" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Why Choose Decking & Pergolas?
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              The strongest landscaping material for lasting security and style
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Steel landscaping is manufactured to the highest Australian standards, 
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl overflow-hidden shadow-elegant">
                <img src="/lovable-uploads/steel-landscaping-features.webp" alt="Decking & Pergolas Features" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Install Your Steel Landscaping?
            </h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              Get free quotes today and experience the strength of premium decking & pergolas
            </p>
...
export default SteelLandscaping;