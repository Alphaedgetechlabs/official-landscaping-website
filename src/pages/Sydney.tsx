...
const Sydney = () => {
  useDocumentTitle("Sydney Landscaping Quotes — Get 3 Free Quotes in Minutes");
  ...
  const recentProjects = [{
    ...
    rating: 5,
    review: "Professional service from start to finish. The team was punctual and the garden looks amazing!"
  }, {
    suburb: "Penrith",
    type: "Turf Installation",
    rating: 5,
    review: "Best landscaping company in Sydney! Highly recommend for quality work and fair pricing."
  }, {
    suburb: "Liverpool",
    type: "Outdoor Renovation",
    rating: 5,
    review: "Exceeded our expectations. Beautiful garden and excellent customer service throughout."
  }];
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">Professional landscaping services across Greater Sydney. Local landscapers, trusted by 3,200+ Sydney homeowners.</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Local landscapers understand Sydney's unique climate, soil conditions, and outdoor living styles</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 accent-gradient rounded-full flex items-center justify-center flex-shrink-0 mt-1">
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img alt="Sydney Landscaping Projects" className="w-full h-full object-cover" src="/lovable-uploads/21d76488-ddb7-46b1-9511-c3cf30307fc5.webp" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            ...
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">Join 1,000's of happy Sydney homeowners. Get your free landscaping quotes in 60 seconds.</p>
